...
@section('og_image', url('/') . '/assets/media/FANTOCHE_mitgliedschaft-lg.jpg')
@section('content')
    ...
    <figure class="visual">
      <picture>
        <source 
          ...
          data-srcset="/assets/media/FANTOCHE_mitgliedschaft-lg.jpg">
        <img 
          data-src="/assets/media/FANTOCHE_mitgliedschaft-sm.jpg" 
