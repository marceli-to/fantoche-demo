...
<div>
  ...
  <form @submit.prevent="submit" v-if="isFetched">
    ...
    <div>
      ...
      <div :class="[this.errors.backer_type_id ? 'has-error' : '', 'form-row']">
    ...
    <page-footer>
      <button-back :route="'backers'">Zurück</button-back>
...
export default {
  ...
  data() {
    return {
      ...
      errors: {
        name: false,
        backer_type_id: false,
      },

      // Routes
      routes: {
        get: '/api/backer',
        getTypes: '/api/backer-types',
        store: '/api/backer',
        update: '/api/backer',
      },
