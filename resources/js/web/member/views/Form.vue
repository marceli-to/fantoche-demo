      ...
      <div class="md:span-6">
        <div class="form-group">
          <div class="flex items-start">
            ...
            <label for="member">Ich trete dem FANTOCHE | 21. INTERNATIONALES FESTIVAL FÜR ANIMATIONSFILM als Mitglied bei. Der Mitgliederbeitrag für das laufende Vereinsjahr von CHF 60.– wird in den nächsten Tagen auf das Postcheck-Konto 84-4044-1 überwiesen.</label>
          </div>
        </div>
        <div class="form-group">
          <div class="flex items-start">
            <input type="radio" id="junior_member" name="member_type" required value="jungmitglied" v-model="form.type">
            <label for="junior_member">Ich trete dem FANTOCHE | 21. INTERNATIONALES FESTIVAL FÜR ANIMATIONSFILM als Jungmitglied (für Studierende und Personen in Ausbildung) bei und sende die Ausbildungsbestätigung an info@forum-architektur.ch. Der Mitgliederbeitrag für das laufende Vereinsjahr* von CHF 30.– wird in den nächsten Tagen auf das Postcheck-Konto 84-4044-1 überwiesen.</label>
          </div>
        </div>
      </div>
      <div class="md:span-6">
        <div class="form-group">
          <div class="flex items-start">
            ...
            <label for="backer">Ich trete dem FANTOCHE | 21. INTERNATIONALES FESTIVAL FÜR ANIMATIONSFILM als Gönner:in bei. Der Beitrag für das laufende Vereinsjahr von CHF 600.– wird in den nächsten Tagen auf das Postcheck-Konto 84-4044-1 überwiesen.</label>
          </div>
        </div>
        <div class="form-group">
          <div class="flex items-start">
            <input type="radio" id="sponsor" name="member_type" required value="sponsor" v-model="form.type">
            <label for="sponsor">Formular Text 4 anpassen: Ich bin interessiert das FANTOCHE | 21. INTERNATIONALES FESTIVAL FÜR ANIMATIONSFILM als Sponsor:in mit jährlich CHF 2'750.– zu unterstützen. Bitte nehmt mit mir Kontakt auf.</label>
          </div>
        </div>
      </div>
    </div>
